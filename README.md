...
Copy the folder in which all codes are written and paste it into the XAMPP's "htdocs" directory.
...
Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/scheduling/.
